...
export const routes: Routes = [
  ...
  { path: 'booking-page', loadComponent: () => import('./components/pages/service-page/service-page.component').then(m => m.ServicePageComponent) },
  { path: 'service-page', redirectTo: 'booking-page', pathMatch: 'full' },
  { path: 'terms-and-conditions', loadComponent: () => import('./components/pages/terms-conditions/terms-conditions.component').then(m => m.TermsConditionsComponent) },
